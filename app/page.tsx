...
import ProjetoFoodDataHub from './components/ProjetoDataNutri';
      ...
      <section className="bg-[var(--contrast-bg-color)] text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg mb-6">
            Desenvolvedor Full Stack especializado em criar aplicações web modernas e responsivas.
          </p>
      ...
      <section id="sobre" className="py-20">
        <div className="container mx-auto px-6">
          ...
          <p className="text-lg leading-7">
            Sou um desenvolvedor apaixonado por tecnologia e inovação. Tenho experiência em várias linguagens e frameworks, incluindo React, Next.js, TypeScript, Tailwind CSS, Angular, .NET Core e Python. Adoro resolver problemas complexos e criar soluções eficientes que atendam às necessidades dos usuários.
          </p>
        </div>
      </section>
